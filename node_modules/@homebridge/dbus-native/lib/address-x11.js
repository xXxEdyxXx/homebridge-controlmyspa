// read dbus address from X11 window selection
// Requires the optional `x11` peer dependency.
...
function getDbusAddress(callback) {
  ...
  try {
    ...
    return callback(
      new Error(
        "address-x11 requires the optional 'x11' package; install it with `npm install x11`"
      )
    );
  }
  // read machine uuid
