...
var plist = tslib_1.__importStar(require("simple-plist"));
...
var plistData = plist.readFileSync(metadataFile);
var simulatorPlistData = plist.readFileSync(defaultPlist);
var simulatorMfiPlistData = fs_1.default.existsSync(defaultMfiPlist) ? plist.readFileSync(defaultMfiPlist) : undefined;
...
try {
    ...
    try {
        ...
        for (var _4 = tslib_1.__values(Object.entries(props).sort(function (_a, _b) {
            var _c = tslib_1.__read(_a, 2), aDef = _c[1];
            var _d = tslib_1.__read(_b, 2), bDef = _d[1];
