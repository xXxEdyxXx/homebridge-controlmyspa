 ...
 */
var MatterFirmwareRevisionNumber = /** @class */ (function (_super) {
    tslib_1.__extends(MatterFirmwareRevisionNumber, _super);
    function MatterFirmwareRevisionNumber() {
        var _this = _super.call(this, "Matter Firmware Revision Number", MatterFirmwareRevisionNumber.UUID, {
            format: "uint32" /* Formats.UINT32 */,
            perms: ["ev" /* Perms.NOTIFY */, "pr" /* Perms.PAIRED_READ */],
        }) || this;
        _this.value = _this.getDefaultValue();
    ...
    MatterFirmwareRevisionNumber.UUID = "0000026D-0000-1000-8000-0026BB765291";
    return MatterFirmwareRevisionNumber;
}(Characteristic_1.Characteristic));
 ...
 */
var MatterFirmwareUpdateStatus = /** @class */ (function (_super) {
    tslib_1.__extends(MatterFirmwareUpdateStatus, _super);
    function MatterFirmwareUpdateStatus() {
        var _this = _super.call(this, "Matter Firmware Update Status", MatterFirmwareUpdateStatus.UUID, {
            format: "tlv8" /* Formats.TLV8 */,
            perms: ["ev" /* Perms.NOTIFY */, "pr" /* Perms.PAIRED_READ */],
        }) || this;
        _this.value = _this.getDefaultValue();
    ...
    MatterFirmwareUpdateStatus.UUID = "0000026E-0000-1000-8000-0026BB765291";
    return MatterFirmwareUpdateStatus;
}(Characteristic_1.Characteristic));
...
var SecuritySystemAlarmType = /** @class */ (function (_super) {
    ...
    SecuritySystemAlarmType.NO_ALARM = 0;
    SecuritySystemAlarmType.UNKNOWN = 1;
