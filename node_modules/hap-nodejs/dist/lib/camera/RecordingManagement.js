...
var CameraRecordingStream = /** @class */ (function (_super) {
    ...
    CameraRecordingStream.prototype.handleClosed = function (closure) {
        ...
        if (this.generator) {
            ...
            void this.generator.return().catch(function (error) { var _a; return debug("[HDS %s] Error while closing recording generator for stream %d: %s", _this.connection.remoteAddress, _this.streamId, (_a = error.stack) !== null && _a !== void 0 ? _a : String(error)); });
